...
impl<O> Circuit<O> {
    ...
    #[inline]
    pub fn push(&mut self, operation: O) {
...
impl DynCircuit {
    pub fn i(&mut self, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::IdentityGate::new(target)));
        self
    }

    pub fn h(&mut self, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::HadamardGate::new(target)));
        self
    }

    pub fn x(&mut self, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::XGate::new(target)));
        self
    }

    pub fn y(&mut self, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::YGate::new(target)));
        self
    }

    pub fn z(&mut self, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::ZGate::new(target)));
        self
    }

    pub fn s(&mut self, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::SGate::new(target)));
        self
    }

    pub fn sdg(&mut self, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::SDaggerGate::new(target)));
        self
    }

    pub fn t(&mut self, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::TGate::new(target)));
        self
    }

    pub fn tdg(&mut self, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::TDaggerGate::new(target)));
        self
    }

    pub fn cx(&mut self, control: usize, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::CXGate::new(control, target)));
        self
    }

    pub fn cy(&mut self, control: usize, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::CYGate::new(control, target)));
        self
    }

    pub fn cz(&mut self, control: usize, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::CZGate::new(control, target)));
        self
    }

    pub fn rx(&mut self, theta: f64, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::RXGate::new(theta, target)));
        self
    }

    pub fn ry(&mut self, theta: f64, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::RYGate::new(theta, target)));
        self
    }

    pub fn rz(&mut self, theta: f64, target: usize) -> &mut Self {
        self.push(Box::new(crate::operations::RZGate::new(theta, target)));
        self
    }

    pub fn swap(&mut self, first: usize, second: usize) -> &mut Self {
        self.push(Box::new(crate::operations::SwapGate::new(first, second)));
        self
    }

    pub fn meas(&mut self, qbit: usize, cbit: usize) -> &mut Self {
        self.push(Box::new(crate::operations::Measure::new(qbit, cbit)));
        self
    }
}
